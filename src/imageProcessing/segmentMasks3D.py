...
class segmentMasks3D:
    ...
    def _segments3Dvolumes(self,image3D_aligned):
        ...
        binary, segmentedImage3D  = _segments3DMasks(image3D_aligned,
                                    axis_norm=(0,1,2),
                                    pmin=1, 
                                    pmax=99.8,
    ...
    def segmentMasks3D_file(self,fileName2Process):
        ...
        if numberMasks >0:
            ...
            NPY_labeled_image_fileName = self.dataFolder.outputFolders["segmentedObjects"]+os.sep+os.path.basename(fileName2Process)
