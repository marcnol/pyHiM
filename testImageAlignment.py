...
def displaysEquializationHistograms(hist1_before, hist1_after,hist2_before, hist2_after, min_threshold, vebose=False, fileName='test'):
...
def imageAdjust(image,fileName='test',lower_threshold=0.3, higher_threshold=.9999,display=False):
...
image1,hist1_before,hist1_after = imageAdjust(image1_uncorrected,outputFileName+'_ref',
                                              lower_threshold1,
                                              higher_threshold=.9999, 
                                              display=verbose) 
image2,hist2_before,hist2_after = imageAdjust(image2_uncorrected,outputFileName,
                                              lower_threshold2,
                                              higher_threshold=.9999, 
                                              display=verbose) 

# shows eq histograms
displaysEquializationHistograms(hist1_before, hist1_after,hist2_before, hist2_after,(lower_threshold1,lower_threshold2),verbose,outputFileName)
