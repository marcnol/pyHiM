        ...
        for currentFolder in dataFolder.listFolders:
            ...
            for fileName in param.fileList2Process:
                ...
                if errorCode==0:
                    ...
                    newImage,hist1_before, hist1, lower_cutoff, higher_cutoff=imageAdjust(newImage,lower_threshold=0.3, higher_threshold=.9999)
                    ...
                    log1.report('File {} accumulated to stack of ROI {}.'.format(fileName,ROI),'info')
                    
                else:
                    log1.report('No 2d corrected image for file {} could be found --> not accumulated'.format(fileName),'warning')
