...
testData['test_appliesRegistrations']['expectedOutput']= rootFolder+"/alignImages/scan_001_RT29_001_ROI_converted_decon_ch00_2d_registered.npy"
...
testData['test_processesPWDmatrices']['expectedOutputs']= [rootFolder+"/segmentedObjects/buildsPWDmatrix_HiMscMatrix.npy"]
