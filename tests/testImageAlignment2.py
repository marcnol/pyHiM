...
from imageProcessing import Image, align_2_images_cross_correlation, save_2_images_rgb
from fileManagement import Folders, Parameters, Session
from fileManagement import Log
from alignImages import align_2_files
from scipy.ndimage import shift as shift_image

import astroalign as aa
import imreg

root_folder = "/home/marcnol/data/Experiment_15/Embryo_006_ROI18/rawData/zProject/"
file_name = root_folder + "scan_001_DAPI_018_ROI_converted_decon_ch01_2d.npy"
filename_reference = root_folder + "scan_004_RT18_018_ROI_converted_decon_ch00_2d.npy"
"""
...
"""
output_filename = "./test/" + os.path.basename(file_name).split(".")[0]

# loads images
image1 = np.load(filename_reference).squeeze()
image2 = np.load(file_name).squeeze()
...
(
    ...
    image1_adjusted,
    image2_adjusted,
) = align_2_images_cross_correlation(image1_uncorrected, image2_uncorrected)
...
save_2_images_rgb(image1_uncorrected, image2_corrected_raw, output_filename + "_overlay_corrected.png")
...
image2_corrected = shift_image(image2_adjusted, shift1)
image2_corrected[image2_corrected < 0] = 0
image2_corrected /= image2_corrected.max()
save_2_images_rgb(image1_uncorrected, image2_corrected, output_filename + "_overlay_corrected_chi2.png")
...
# thresholds corrected images for better display and saves
save_2_images_rgb(
    image1_uncorrected, image2_corrected, output_filename + "_overlay_corrected_imregdft.png",
)
