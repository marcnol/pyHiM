...
x1 = np.concatenate((make_data1(f*N[0],errorAmp=errorAmp,baseline=baselines[0]),make_data1((1-f)*N[0],errorAmp=errorAmp,baseline=baselines[1])))
x2 = np.concatenate((make_data1(f*N[1],errorAmp=errorAmp,baseline=baselines[0]),make_data1((1-f)*N[1],errorAmp=errorAmp,baseline=baselines[1])))
x=[x1,x2]
